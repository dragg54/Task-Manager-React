...
const Login = () => {
    ...
    return (
        <div className="w-[100wh] h-[100vh] flex justify-center items-center bg-[#efefef]">
            <form action="" onSubmit={(e)=>handleSubmit(e)} className='w-[550px] h-[280px]  bg-bgImg  bg-contain bg-no-repeat bg-right py-6 px-4 flex justify-between items-start flex-col bg-white rounded-lg'>
